const startup = [
  ...
  },
  {
    title: "Equity",
    description:
      "Weekly podcast focused on all things money when it comes to startups.",
  ...
  },
  {
    title: "Rocketship.fm",
    description:
      "Essential listening for entrepreneurs and anyone working in tech today.",
  ...
  },
  {
    ...
    description:
      "Each episode explores the inspiring stories behind how people grow a business.",
  ...
  },
  {
    title: "ETL",
    description:
      "Entrepreneurial stories of the secrets and setbacks behind success.",
  ...
  },
  {
    title: "The Podcast",
    description:
      "Stories from managing a bootstrapped, remote-only company (and more).",
  ...
  },
  {
    title: "Schmidt List",
    description:
      "Interviews with people who manage, build, and lead product design teams.",
  ...
  },
  {
    ...
    description:
      "The MicroConf founders share their tumultuous life of two entrepreneurs.",
